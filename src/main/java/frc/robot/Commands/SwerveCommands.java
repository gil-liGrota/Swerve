...
public class SwerveCommands {
        ...
        private static final double ANGLE_KP = 1.3;
        private static final double ANGLE_KD = 0;
        private static final double ANGLE_MAX_VELOCITY = 1.5;
        private static final double ANGLE_MAX_ACCELERATION = 1.5;
        ...
        public static Command goToAngle(Swerve drive, Rotation2d goal) {
                ProfiledPIDController angleController = new ProfiledPIDController(
                                ...
                                new TrapezoidProfile.Constraints(ANGLE_MAX_VELOCITY, ANGLE_MAX_ACCELERATION));
                angleController.enableContinuousInput(-Math.PI, Math.PI);
                angleController.setTolerance(0.035);
